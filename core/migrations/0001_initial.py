    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ta_created_at', models.DateTimeField(auto_now_add=True)),
                ('exercise_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.exercises')),
                ('muscle_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.muscles')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ta_created_at', models.DateTimeField(auto_now_add=True)),
                ('attachment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.attachments')),
                ('date_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.calendar')),
                ('equipment_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.equipment')),
                ('exercise_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.exercises')),
            ],
            options={
                'db_table': 'core.workouts',
            },
        ),
    ]
